...
public class Main {
	...
	public static void main(String[] args) {
		...
		callCenter101.addListener(policeDepartmentGhent);
		callCenter112.addListener(hospitalUZ);
		callCenter112.addListener(hospitalAZ);
		callCenter112.addListener(policeDepartmentGhent);
		callCenter112.addListener(fireDepartmentGhent);
		callCenter112.addListener(fireDepartmentAntwerp);
